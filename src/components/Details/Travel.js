        ...
        <section className="detail-overview">
          <div className="detail-intro">
            ...
            <p>
              ...
              chooses the favicon canvas size, they can easily make their
              artwork a favicon in their web project.
            </p>
            <p>
              {" "}
              This website was created using{" "}
              <span>React, Javascript, and Sass</span> For the export
              functionality, I use <span>React-component-export-image</span>{" "}
              which allows for fast and easy downloads.{" "}
            </p>
